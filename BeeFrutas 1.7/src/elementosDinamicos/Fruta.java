...
public class Fruta extends JLabel{
	...
	public boolean estaBichada;
	public String tipoFruta;
	
	public Fruta(int x, int y, int tamanhoIcone, int probBichada){
		setUrlIcone();
		...
		this.setIcon(image);
		this.estaBichada = gerarBooleanAleatorio(probBichada);
	}
	...
	private static boolean gerarBooleanAleatorio(int probBichada) {
		double probBichadaTemp = (double) probBichada/100;
		return Math.random() < probBichadaTemp;
	}
