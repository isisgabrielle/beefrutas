...
public class Arvore extends Floresta{
	...
	@Override
	public Fruta derrubarFrutaArvore(int dono, int probBichada) {
		switch (this.tipoArvore) {
		case "Laranja": fruta = new Laranja(this.x, this.y, this.tamanhoIcone, probBichada);
						fruta.estaNaMochila = dono; break;
		case "Abacate": fruta = new Abacate(this.x, this.y, this.tamanhoIcone, probBichada);
						fruta.estaNaMochila = dono; break;				
		case "Coco":    fruta = new Coco(this.x, this.y, this.tamanhoIcone, probBichada);
						fruta.estaNaMochila = dono; break;
		case "Acerola": fruta = new Acerola(this.x, this.y, this.tamanhoIcone, probBichada);
						fruta.estaNaMochila = dono; break;
		case "Amora":   fruta = new Amora(this.x, this.y, this.tamanhoIcone, probBichada);
						fruta.estaNaMochila = dono; break;
		case "Goiaba":  fruta = new Goiaba(this.x, this.y, this.tamanhoIcone, probBichada);
						fruta.estaNaMochila = dono; break;
		}
		return fruta;
	}
