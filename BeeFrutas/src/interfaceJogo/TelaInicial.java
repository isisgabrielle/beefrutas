...
public class TelaInicial extends JFrame {
	...
	private JTextField textJogador2;
	...
	public TelaInicial() {
		...
		botaoPartida.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				try {
					JanelaPartida main = new JanelaPartida(obterInteirosInicializacao(textVariaveisInicializacao));
					setVisible(false);
				}
		...
		JLabel labelJogador1 = new JLabel("Nome do Jogador 1");
		...
		JLabel labelJogador2 = new JLabel("Nome do Jogador 2");
		panel_4.add(labelJogador2);
		
		textJogador2 = new JTextField();
		panel_4.add(textJogador2);
		textJogador2.setColumns(10);
