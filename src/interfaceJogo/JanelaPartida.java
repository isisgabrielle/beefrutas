...
public class JanelaPartida extends JFrame implements KeyListener, ActionListener{
	...
	private void iniciarPartida() {
	    ...
	    rollButton.addActionListener(new ActionListener() {
	     ...
	     public void actionPerformed(ActionEvent e) {
	    	 		 dado1.rolarDado(); 
	    	 		 dado2.rolarDado();
	    	 		 System.out.println("Dado 1: " + dado1.getValorFace() + ", Dado 2: " + dado2.getValorFace());
	    	 		 pontosMovimento = dado1.getValorFace() + dado2.getValorFace();
	    	 		 System.out.println("Pontos de Movimento Inicial: " + pontosMovimento);
	...
	public void keyPressed(KeyEvent e) {
		...
		if(pontosMovimento > 0) {
		  ...
		  System.out.println("Pontos de Movimento antes do movimento: " + pontosMovimento);
